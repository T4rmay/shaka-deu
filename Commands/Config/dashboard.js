        ...
        if (args[0] === "admin") {
            ...
            .addComponents(
                ...
                .addOptions([
                    {
                        label: "Antilink",
                        description: "Akzeptieren und Deaktivieren Antilink-System!",
                        value: "antilink",
                    },
                    {
                        label: "AutoRole",
                        description: "Akzeptieren und Deaktivieren AutoRole-System!",
                        value: "autorole",
                    },
                    {
                        label: "AutoMod",
                        description: "Akzeptieren und Deaktivieren AutoMod -ystem!",
                        value: "automod",
                    },
                    {
                        label: "Prefix",
                        description: "Der Prefix für Ihren Server ändern.",
                        value: "prefix"
                    }
                ])
            )
            ...
            return message.channel.send("🚫 | Ups, Meister!! Diese Option scheint nicht zu existieren!!")
        }
    }
}