  ...
  run: async(client, message, args) => {
    ...
    if (args[0] === "On" || args[0] === "on") {
      ...
      if (data) {
        ...
        message.channel.send(`**Antiwords wurde jetzt aktiviert!**`);
      ...
      if (data2) {
        ...
        return message.channel.send(`**Antiwords wurde jetzt deaktiviert!**`);

      } else if (!data2) {
        return message.channel.send(`**Antiwords ist nicht mal eingerichtet!**`);
      }
    }
  }
}
