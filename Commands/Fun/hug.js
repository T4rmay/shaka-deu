...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    let HugEmbed = new Discord.MessageEmbed()
      .setTitle(
        `Meister: ${message.author.username} Sie können sich nicht umarmen, aber komm her ich umarme Ihnen!! :smiling_face_with_3_hearts:`
      )
    ...
    let HugEmbed2 = new Discord.MessageEmbed()
      .setTitle(
        `${message.author.username} hugs ${member.user.username}, wie süssss~~ :smiling_face_with_3_hearts:`
      )
      .setImage(String([images[image]]))
      .setColor(0xf000ff);
