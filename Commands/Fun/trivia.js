  ...
  run: async (client, message, args) => {
    ...
    try {
      ...
      if (parseInt(msgs.first().content) == q.correct) {
        return message.channel.send(`✅ | WOW, Glükwunsch!! Meister, Sie haben die richtige Antwort gegeben!! Wenn es keinen Grund zum Feiern ist.. :tada: :partying_face:`);
      } else {
      ...
      return message.channel.send(`🚫 | Meister, Sie haben mir leider keine Antwort darauf gegeben! Sie können gern später nochmal versuchen, vielleicht haben Sie dann ja Glück :)`);
    }
  },
};
