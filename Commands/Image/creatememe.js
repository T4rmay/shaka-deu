  ...
  run: async (client, message, args) => {
    ...
    if (!memetemplate) {
      return message.channel.send(
        "🚫 | Meister, Sie haben die Vorlage nicht erwähnt!. Um die verfügbaren Meme-Vorlagen anzuzeigen, type `=memetemplates`"
      );
    }
    ...
    errorlogs.send("Fehler beim Creatememe-Befehl! \n\nError:\n\n" + error);
  },
};
