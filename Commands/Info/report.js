...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    message.channel.send(
      `${message.author}, Ihr Bericht wurde erfolgreich übermittelt. Unser Mod-Teams werden Ihnen so schnell wie möglich antworten`
    );
    ...
    errorlogs.send("Fehler beim Meldebefehl \nError: \n" + error);
  },
};
