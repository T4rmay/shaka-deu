  ...
  if (antilink) {
    ...
    )
    {
      ...
      let msg = message.channel.send(
        `🚫 | Meister!! Keinen Links sind hier erlaubt, weil Anti-Link momentan Aktiv ist! Kontaktieren Sie entweder meinen Geliebten Meister **꧁Saito꧂#6248** oder Server-Team.`
      ).then((msg) => {
        let time = "3s";
        setTimeout(function() {
          msg.delete();
